  ...
  const fetchFormData = async (payload) => {
    try {
      const response = await fetch(
        "https://api.finclouds.tech/api/v1/web/LendingLeadInsertAPI",
        {
          method: "POST",
          headers: {
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  const faqData = [
    ...
    },
    {
      ...
      answer:
        "RupeeLending offers a fast, convenient, and fully digital experience. Unlike traditional methods involving lengthy paperwork and slow approvals, RupeeLending requires minimal documentation and provides instant approvals. With flexible loan amounts and 24/7 online availability, it’s a seamless and hassle-free solution.",
    },
    {
    ...
    },
    {
      ...
      answer:
        "With RupeeLending, you can borrow from ₹5,000 to ₹1,00,000 based on your eligibility and needs.",
    },
    {
    ...
    container.innerHTML = faqData
      ...
      <details class="bg-white p-4 border border-green-400 rounded-lg shadow group">
        <summary class="font-semibold cursor-pointer list-none flex justify-between items-center">
          ${item.question}
          <span class="transition-transform transform group-open:rotate-180 text-green-600">▼</span>
        </summary>
